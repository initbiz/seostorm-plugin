<?php return [
    ...
    'form' => [
        'general' => [
            'meta_title_label' => 'Page title (dynamic)',
            'meta_title_comment' => 'Page title',
            'meta_description_label' => 'Page description (dynamic)',
            'meta_description_comment' => 'Page description',
            'og_title_label' => 'og:title (dynamic)',
            'og_title_comment' => 'Recommended 50-60 characters',
            'og_title_placeholder' => 'Defaults to SEO if left blank',
            'og_description_label' => 'og:description (dynamic)',
            'og_description_comment' => 'The optimal length is 155',
            'og_description_placeholder' => 'Defaults to SEO if left blank',
            'canonical_url_label' => 'Canonical URL (dynamic)',
            ...
            'robot_advanced_label' => 'Advanced robots (dynamic)',
            ...
            'model_class_comment_placeholder' => 'Author\Plugin\Models\ModelClass',
